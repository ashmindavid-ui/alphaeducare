export const COUNTRIES_DATA = [
  {
    id: 'united-kingdom',
    name: 'United Kingdom',
    flag: 'https://flagcdn.com/w160/uk.png',
  ...
  },
  {
    ...
    cityImages: {
      ...
      'Los Angeles': 'https://images.unsplash.com/photo-1580655653885-97d83614acd1?auto=format&fit=crop&w=600&h=400&q=80',
      ...
      'Dallas': 'https://images.unsplash.com/photo-1485738422979-f5c462d49f74?auto=format&fit=crop&w=600&h=400&q=80',
    },
    popularPrograms: [
      'Computer Science',
      'Engineering',
    ...
    universities: [
      ...
      { name: 'Stanford University', domain: 'stanford.edu', logo: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Stanford_plain_block_%22S%22_logo.svg' },
  ...
  },
  {
    ...
    universities: [
      ...
      { name: 'Université de Montréal', domain: 'umontreal.ca', logo: 'https://upload.wikimedia.org/wikipedia/commons/3/30/Universität_Montreal_Logo.svg' },
  ...
  },
  {
    ...
    cityImages: {
      ...
      'Maynooth': 'https://images.unsplash.com/photo-1590089415225-401ed6f9db8e?auto=format&fit=crop&w=600&h=400&q=80',
    },
    popularPrograms: [
      'Data Analytics',
      'Computer Science',
    ...
    universities: [
      ...
      { name: 'University College Dublin', domain: 'ucd.ie', logo: '' },
      { name: 'University of Galway', domain: 'universityofgalway.ie', logo: '' },
      { name: 'University College Cork', domain: 'ucc.ie', logo: '' },
      ...
      { name: 'University of Limerick', domain: 'ul.ie', logo: '' },
      { name: 'Maynooth University', domain: 'mu.ie', logo: '' },
  ...
  },
  {
    ...
    universities: [
      ...
      { name: 'University of Sydney', domain: 'sydney.edu.au', logo: '' },
      { name: 'UNSW Sydney', domain: 'unsw.edu.au', logo: '' },
      ...
      { name: 'University of Queensland', domain: 'uq.edu.au', logo: '' },
      ...
      { name: 'University of Technology Sydney', domain: 'uts.edu.au', logo: '' },
    ],
  },
  {
    id: 'new-zealand',
    ...
    universities: [
      ...
      { name: 'University of Waikato', domain: 'waikato.ac.nz', logo: '' },
      { name: 'Lincoln University', domain: 'lincoln.ac.nz', logo: 'https://upload.wikimedia.org/wikipedia/commons/a/a2/LU_logo.jpg' },
  ...
  },
  {
    ...
    universities: [
      { name: 'Lund University', domain: 'lu.se', logo: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/Logotyp_Lunds_universitet_%28vit%29.png' },
      { name: 'Uppsala University', domain: 'uu.se', logo: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Uppsala_universitet_logo.jpg' },
      { name: 'Stockholm University', domain: 'su.se', logo: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Stockholms_universitet_Coat_of_Arms_old.svg' },
      ...
      { name: 'University of Gothenburg', domain: 'gu.se', logo: '' },
  ...
  },
  {
    ...
    universities: [
      ...
      { name: 'University of Turku', domain: 'utu.fi', logo: '' },
  ...
  },
  {
    ...
    universities: [
      ...
      { name: 'University of Florence', domain: 'unifi.it', logo: '' },
      { name: 'University of Padua', domain: 'unipd.it', logo: '' },
      { name: 'University of Trento', domain: 'unitn.it', logo: '' },
    ],
  },
  {
    id: 'malta',
    ...
    universities: [
      ...
      { name: 'Malta College of Arts, Science and Technology', domain: 'mcast.edu.mt', logo: '' },
      { name: 'American University of Malta', domain: 'aum.edu.mt', logo: '' },
      { name: 'Global College Malta', domain: 'globalcollegemalta.com', logo: '' },
      { name: 'London School of Commerce Malta', domain: 'lscmalta.com', logo: '' },
      { name: "St. Martin's Institute of Higher Education", domain: 'stmartins.edu', logo: '' },
    ],
  },
];
